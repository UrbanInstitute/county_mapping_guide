...
Please contact [Vincent Pancini](mailto:vpancini@urban.org) or [Aaron R. Williams](mailto:awilliams@urban.org) with any comments, questions, or concerns.
...
## Coordinate Reference Systems {.tabset}
### Brief
...
## Types of Geospatial Data {.tabset}
### Brief
...
## Example 1 - Tract using tidycensus {.tabset}
...
## Example 2 - ZCTA using tidycensus {.tabset}
...
## Example 3 - PUMA using tidycensus {.tabset}
...
## Example 4 - PUMA and loading in original data {.tabset}
