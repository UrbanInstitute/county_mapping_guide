...
Below is an example of using the `get_acs()` function from `library(tidycensus)` to get median income from the Census in Fairfax County, VA, along with cartographic boundary files.
```{r eval = FALSE}
